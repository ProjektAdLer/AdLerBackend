...
public class DeletePlayerDataUseCase : IRequestHandler<DeletePlayerDataCommand, bool>
{
    private readonly ILMS _ilms;
    private readonly IPlayerRepository _playerRepository;

    public DeletePlayerDataUseCase(IPlayerRepository playerRepository, ILMS ilms)
    {
