...
namespace AdLerBackend.Application.Common.ElementStrategies.ScoreElementStrategies.ScoreH5PStrategy
{
    public class ScoreH5PElementStrategyHandler : IRequestHandler<ScoreH5PElementStrategyCommand, ScoreElementResponse>
    {
        ...
        private RawH5PEvent DeserializeAndUpdateXapiEvent(ScoreH5PElementStrategyCommand request, LMSUserDataResponse userData, string moodleUrl)
        {
            var xapiEvent = _serialization.GetObjectFromJsonString<RawH5PEvent>(request.ScoreElementParams.SerializedXapiEvent 
